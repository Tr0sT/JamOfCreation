    ...
    private void _RegisterDependencies()
    {
        ...
        if (rives != null)
        {
            foreach (var rive in rives)
            {
                ...
                {
                    NoesisXamlProvider.instance.Register(rive.uri, rive.rive.content);

                    if (rive.rive.textures != null)
                    {
                        foreach (var texture in rive.rive.textures)
                        {
                            if (texture.uri != null && texture.texture != null)
                            {
                                NoesisTextureProvider.instance.Register(texture.uri, texture.texture);
                    ...
                    if (rive.rive.fonts != null)
                    {
                        foreach (var font in rive.rive.fonts)
                        {
                            if (font.uri != null && font.font != null)
                            {

...
namespace Noesis
{
    public partial class Texture
    {
        ...
        internal static HandleRef WrapTexture(UnityEngine.Texture tex)
        {
            if (tex == null)
            {
        ...
        internal static HandleRef WrapTexture(UnityEngine.Texture2D tex)
        {
            if (tex == null)
            {
                return new HandleRef(null, IntPtr.Zero);
        ...
        private static HandleRef WrapTexture(object texture, IntPtr nativePointer,
            int width, int height, int numLevels)
        {
            ...
            return new HandleRef(texture, texturePtr);
        }

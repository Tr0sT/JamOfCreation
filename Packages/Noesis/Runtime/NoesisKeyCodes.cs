internal class NoesisKeyCodes
{
    ...
    static NoesisKeyCodes()
    {
        ...
        _unityToNoesis.Add(UnityEngine.KeyCode.Keypad0, Noesis.Key.NumPad0);
        _unityToNoesis.Add(UnityEngine.KeyCode.Keypad1, Noesis.Key.NumPad1);
        _unityToNoesis.Add(UnityEngine.KeyCode.Keypad2, Noesis.Key.NumPad2);
        _unityToNoesis.Add(UnityEngine.KeyCode.Keypad3, Noesis.Key.NumPad3);
        _unityToNoesis.Add(UnityEngine.KeyCode.Keypad4, Noesis.Key.NumPad4);
        _unityToNoesis.Add(UnityEngine.KeyCode.Keypad5, Noesis.Key.NumPad5);
        _unityToNoesis.Add(UnityEngine.KeyCode.Keypad6, Noesis.Key.NumPad6);
        _unityToNoesis.Add(UnityEngine.KeyCode.Keypad7, Noesis.Key.NumPad7);
        _unityToNoesis.Add(UnityEngine.KeyCode.Keypad8, Noesis.Key.NumPad8);
        _unityToNoesis.Add(UnityEngine.KeyCode.Keypad9, Noesis.Key.NumPad9);
        ...
        _unityToNoesis.Add(UnityEngine.KeyCode.Alpha0, Noesis.Key.D0);
        _unityToNoesis.Add(UnityEngine.KeyCode.Alpha1, Noesis.Key.D1);
        _unityToNoesis.Add(UnityEngine.KeyCode.Alpha2, Noesis.Key.D2);
        _unityToNoesis.Add(UnityEngine.KeyCode.Alpha3, Noesis.Key.D3);
        _unityToNoesis.Add(UnityEngine.KeyCode.Alpha4, Noesis.Key.D4);
        _unityToNoesis.Add(UnityEngine.KeyCode.Alpha5, Noesis.Key.D5);
        _unityToNoesis.Add(UnityEngine.KeyCode.Alpha6, Noesis.Key.D6);
        _unityToNoesis.Add(UnityEngine.KeyCode.Alpha7, Noesis.Key.D7);
        _unityToNoesis.Add(UnityEngine.KeyCode.Alpha8, Noesis.Key.D8);
        _unityToNoesis.Add(UnityEngine.KeyCode.Alpha9, Noesis.Key.D9);

        _unityToNoesis.Add(UnityEngine.KeyCode.Semicolon, Noesis.Key.OemSemicolon); // Oem1
        _unityToNoesis.Add(UnityEngine.KeyCode.Slash, Noesis.Key.OemQuestion); // Oem2
        _unityToNoesis.Add(UnityEngine.KeyCode.BackQuote, Noesis.Key.OemTilde); // Oem3
        _unityToNoesis.Add(UnityEngine.KeyCode.LeftBracket, Noesis.Key.OemOpenBrackets); // Oem4
        _unityToNoesis.Add(UnityEngine.KeyCode.Pipe, Noesis.Key.OemPipe); // Oem5
        _unityToNoesis.Add(UnityEngine.KeyCode.RightBracket, Noesis.Key.OemCloseBrackets); // Oem6
        _unityToNoesis.Add(UnityEngine.KeyCode.Quote, Noesis.Key.OemQuotes); // Oem7
        _unityToNoesis.Add(UnityEngine.KeyCode.Backslash, Noesis.Key.OemBackslash); // Oem102
